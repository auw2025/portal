...
Partial Class StudentRecord
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'If Request.Url.ToString = "https://www.tsss.edu.hk/sims_ex/StudentRecord_v2.aspx" Then
    ...
    Protected Sub BtnViewStudentRecord_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Left(Me.TextBox1.Text, 2) = "25" Then
            Me.DropDownListKAA.Items.Add("25-26")
...
"pointHighlightStroke: 'rgba(151,187,205,1)'," & vbCrLf &
    ...
    Protected Sub DropDownListKAA_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DropDownListKAA.SelectedIndexChanged
        ...
        ElseIf Me.DropDownListKAA.Text = "24-25" Then
            Response.Redirect("https://www.tsss.edu.hk/sims_ex/StudentRecordAFchart2425.aspx?pn=" + Me.TextBox1.Text)
        ElseIf Me.DropDownListKAA.Text = "25-26" Then
    ...
    Protected Sub DropDownListKAA0_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DropDownListKAA0.SelectedIndexChanged
        ...
        ElseIf Me.DropDownListKAA0.Text = "24-25 Term 1" Then
    ...
    'Refresh the grid when the user clicks the Search button
    Protected Sub btnSearchStudent_Click(ByVal sender As Object, ByVal e As EventArgs)
        gvSearchResult.Visible = True
        gvSearchResult.PageIndex = 0    'always start on first page for a new search
        gvSearchResult.DataBind()
    End Sub

    'Handle page clicks
    Protected Sub gvSearchResult_PageIndexChanging(ByVal sender As Object,
                                                ByVal e As GridViewPageEventArgs)
        gvSearchResult.PageIndex = e.NewPageIndex
        gvSearchResult.DataBind()       're-query via the SqlDataSource
    End Sub
    ...
    Protected Sub gvSearchResult_Sorting(sender As Object,
